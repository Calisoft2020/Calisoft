...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['Codificacion',  {{$codificacion}},faltanteCodigo,((100*{{$codificacion}})/sumatoria)],
      ...
      function horizontal() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            ['Codificacion', {{$codificacion}},'color: #e67e22; opacity: 0.2'],
...
@section('content')
    <div class="col-md-12">
        ...
        <div id="app">
            <div class="row">
                <!-- BARRA DE NAVEGACION -->                    
                <div class="tab">
                    <button style="color: #2980b9;" class="tablinks"><b>{{link_to_route('evaluador-general', 'Lista de resultados')}}</b></button>
                    <button style="color: #2980b9;" class="tablinks"><b>{{link_to_route('resultado-general-individual','Ver otras opciones',['id' => Crypt::encryptString($pj['0']->PK_id)])}}</b></button>
                </div>
            </div>
                <!-- RESULTADOS -->
            <br/>
    ...
    @include('partials.modal-help-evaluator-graficas-general')
@endsection
<script type="text/javascript">
