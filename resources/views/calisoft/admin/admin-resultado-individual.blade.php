...
<div class="col-md-12">
    @component('components.portlet', 
        ...
        'title' => 'Resultados del proyecto: '.$proyecto[0]->nombre
        ])
    <div id="app">

        <div align="center">
            <table id="tabla" name="tabla" style="width: 100%" class="table table-bordered">
                <tbody>
                    <tr>
                        <td style="width: 20%">
        ...
        <div class="tab">
            <button style="color: #2980b9;" class="tablinks"><b>{{link_to_route('resultadosAdmin', 'Lista de proyectos')}}</b></button>
            ...
            <button style="color: #2980b9;" class="tablinks">{{link_to_route('admin-grafica-general','Graficas',['id' => Crypt::encryptString($proyecto[0]->PK_id)])}}</button>
        </div>
        ...
        <div id="Porcentajes" class="tabcontent">
            @component('components.porlet-post-action', [ 
                    ...
                    'color' => '#e74c3c',
                    'colorIcon' => '#e74c3c',
                    'url' => route('pdf.admin-porcentaje-general',['id' => Crypt::encryptString($proyecto[0]->PK_id)])
                ])
                @endcomponent
                <br/>
                <br/>
                <ul class="list-group" style="width: 100%;">
                    <li class="list-group-item">Modelación: 
                    ...
                    <li class="list-group-item">Codificación: 
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" role="progressbar"
        ...
        <div id="Tablas" class="tabcontent">
            @component('components.porlet-post-action', [ 
                    ...
                    'color' => '#e74c3c',
                    'colorIcon' => '#e74c3c',
                    'url' => route('pdf.admin-tabla-general',['id' => Crypt::encryptString($proyecto[0]->PK_id)])
                    ])
            @endcomponent
            <div align="center">
                <br/>
        ...
        @include('partials.modal-help-admin-proyecto-individual')
    </div>
    @endcomponent
  </div>
...
<script type="text/javascript">
    ...
    /* Para obtener el valor de cada option del select*/
        var opcion = document.getElementById("Tablas").value;
