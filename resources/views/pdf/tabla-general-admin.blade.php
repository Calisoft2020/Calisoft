...
@section('body')
    <div class="text-center">
        ...
        <br/>
        <br/>
        <h4 align="justify"><b>Nota:</b> Si la tabla que contiene los resultados de la evaluación de este proyecto 
            aparece pintada de color verde, significa que el proyecto esta por encima del 
            ...
            <tr>
                ...
                <!--TABLA QUE CONTIENE EL PROYECTO DEL ESTUDIANTE-->
                    <table class="table table-hover" 
                        style=" ;width: 100%;
                        @if ($promedioGeneralTotalTabla > $total)
